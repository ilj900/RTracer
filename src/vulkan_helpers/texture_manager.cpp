...
ImagePtr FTextureManager::CreateStorageImage(uint32_t WidthIn, uint32_t HeightIn, VkFormat Format, const std::string& DebugName)
{
    return VK_CONTEXT()->CreateImage2D(WidthIn, HeightIn, false, VK_SAMPLE_COUNT_1_BIT, Format, VK_IMAGE_TILING_OPTIMAL,
...
ImagePtr FTextureManager::CreateClearableStorageImage(uint32_t WidthIn, uint32_t HeightIn, VkFormat Format, const std::string& DebugName)
{
	return VK_CONTEXT()->CreateImage2D(WidthIn, HeightIn, false, VK_SAMPLE_COUNT_1_BIT, Format, VK_IMAGE_TILING_OPTIMAL,
...
ImagePtr FTextureManager::CreateSampledStorageImage(uint32_t WidthIn, uint32_t HeightIn, VkFormat Format, const std::string& DebugName)
{
    return VK_CONTEXT()->CreateImage2D(WidthIn, HeightIn, false, VK_SAMPLE_COUNT_1_BIT, Format, VK_IMAGE_TILING_OPTIMAL,
