...
vec3 EvaluateMaterialInteraction(FDeviceMaterial Material, uint RayType, vec3 IncomingDirection, vec3 OutgoingDirection, vec3 NormalInWorldSpace, inout FSamplingState SamplingState)
{
	vec3 BXDF = vec3(0.f);
