...
/// Task sample spot light set layout defines
#define RAYTRACE_SAMPLE_SPOT_LIGHT_LAYOUT_INDEX 								0u

#define RAYTRACE_SAMPLE_SPOT_LIGHT_TLAS_INDEX 									0u
#define RAYTRACE_SAMPLE_SPOT_LIGHT_SPOT_LIGHTS_BUFFER_INDEX						1u
#define RAYTRACE_SAMPLE_SPOT_LIGHT_UNIFORM_BUFFER_INDEX							2u
#define RAYTRACE_SAMPLE_SPOT_LIGHT_NORMAL_AOV_BUFFER_INDEX 						3u
#define RAYTRACE_SAMPLE_SPOT_LIGHT_WORLD_SPACE_POSITION_AOV_BUFFER_INDEX 		4u
#define RAYTRACE_SAMPLE_SPOT_LIGHT_SAMPLED_LIGHT_BUFFER_INDEX 					5u
#define RAYTRACE_SAMPLE_SPOT_LIGHT_PIXEL_INDEX_BUFFER 							6u
#define RAYTRACE_SAMPLE_SPOT_LIGHT_RENDER_ITERATION_BUFFER_INDEX 				7u
...
#define COMPUTE_SHADE_SPOT_LIGHT_SAMPLING_RESULT_INDEX							7u
#define COMPUTE_SHADE_MATERIAL_INDEX_MAP 										8u
#define COMPUTE_SHADE_MATERIAL_INDEX_AOV_MAP 									9u
#define COMPUTE_SHADE_MATERIALS_OFFSETS 										10u
#define COMPUTE_SHADE_CUMULATIVE_MATERIAL_COLOR_BUFFER_INDEX					11u
#define COMPUTE_SHADE_THROUGHPUT_BUFFER 										12u
#define COMPUTE_SHADE_RENDER_ITERATION_BUFFER 									13u
#define COMPUTE_SHADE_NORMAL_AOV_DATA_BUFFER 									14u
#define COMPUTE_SHADE_UV_AOV_DATA_BUFFER 										15u
#define COMPUTE_SHADE_WORLD_SPACE_POSITION_AOV_DATA_BUFFER 						16u
