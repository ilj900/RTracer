...
#define COMPUTE_SHADE_DIRECTIONAL_LIGHT_SAMPLING_RESULT_INDEX					5u
#define COMPUTE_SHADE_MATERIAL_INDEX_MAP 										6u
#define COMPUTE_SHADE_MATERIAL_INDEX_AOV_MAP 									7u
#define COMPUTE_SHADE_MATERIALS_OFFSETS 										8u
#define COMPUTE_SHADE_CUMULATIVE_MATERIAL_COLOR_BUFFER_INDEX					9u
#define COMPUTE_SHADE_THROUGHPUT_BUFFER 										10u
#define COMPUTE_SHADE_RENDER_ITERATION_BUFFER 									11u
#define COMPUTE_SHADE_NORMAL_AOV_DATA_BUFFER 									12u
#define COMPUTE_SHADE_UV_AOV_DATA_BUFFER 										13u
#define COMPUTE_SHADE_WORLD_SPACE_POSITION_AOV_DATA_BUFFER 						14u
