...
#define MASTER_SHADER_AREA_LIGHTS_ALIAS_TABLE_BUFFER_REFERENCE_INDEX			17u
#define MASTER_SHADER_IBL_IMPORTANCE_BUFFER_INDEX								18u
#define MASTER_SHADER_IBL_IMAGE_SAMPLER_INDEX									19u
#define MASTER_SHADER_IBL_PDF_BUFFER_INDEX										20u
#define MASTER_SHADER_UTILITY_BUFFER_INDEX 										21u
#define MASTER_SHADER_RENDER_ITERATION_BUFFER_INDEX 							22u
#define MASTER_SHADER_CUMULATIVE_MATERIAL_COLOR_BUFFER_INDEX					23u
#define MASTER_SHADER_NORMAL_BUFFER												24u
#define MASTER_SHADER_THROUGHPUT_BUFFER											25u
#define MASTER_SHADER_COLOR_AOV_IMAGE_INDEX 									26u
#define MASTER_SHADER_SHADING_NORMAL_AOV_IMAGE_INDEX 							27u
#define MASTER_SHADER_GEOMETRIC_NORMAL_AOV_IMAGE_INDEX							28u
#define MASTER_SHADER_UV_AOV_IMAGE_INDEX										29u
#define MASTER_SHADER_WORLD_SPACE_POSITION_AOV_IMAGE_INDEX						30u
#define MASTER_SHADER_OPACITY_AOV_IMAGE_INDEX									31u
#define MASTER_SHADER_DEPTH_AOV_IMAGE_INDEX										32u
#define MASTER_SHADER_ALBEDO_AOV_IMAGE_INDEX									33u
#define MASTER_SHADER_LUMINANCE_AOV_IMAGE_INDEX									34u
#define MASTER_SHADER_RENDERABLE_INDEX_IMAGE_INDEX								35u
#define MASTER_SHADER_PRIMITIVE_INDEX_IMAGE_INDEX								36u
#define MASTER_SHADER_MATERIAL_INDEX_IMAGE_INDEX								37u
#define MASTER_SHADER_DEBUG_LAYER_IMAGE_INDEX									38u
...
#define COMPUTE_MISS_DEBUG_LAYER_IMAGE_INDEX									21u
