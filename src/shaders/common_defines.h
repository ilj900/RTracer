...
#define MASTER_SHADER_RAYS_BUFFER_INDEX 										1u
#define MASTER_SHADER_HITS_BUFFER_INDEX 										2u
#define MASTER_SHADER_RENDERABLES_BUFFER_INDEX 									3u
#define MASTER_SHADER_TRANSFORMS_BUFFER_INDEX 									4u
#define MASTER_SHADER_PIXEL_INDEX_BUFFER 										5u
#define MASTER_SHADER_DIRECTIONAL_LIGHTS_BUFFER_INDEX 							6u
#define MASTER_SHADER_SPOT_LIGHTS_BUFFER_INDEX 									7u
#define MASTER_SHADER_POINT_LIGHTS_BUFFER_INDEX 								8u
#define MASTER_SHADER_UTILITY_BUFFER_INDEX 										9u
#define MASTER_SHADER_RENDER_ITERATION_BUFFER_INDEX 							10u
#define MASTER_SHADER_COLOR_AOV_IMAGE_INDEX 									11u
#define MASTER_SHADER_SHADING_NORMAL_AOV_IMAGE_INDEX 							12u
#define MASTER_SHADER_GEOMETRIC_NORMAL_AOV_IMAGE_INDEX							13u
#define MASTER_SHADER_UV_AOV_IMAGE_INDEX										14u
#define MASTER_SHADER_WORLD_SPACE_POSITION_AOV_IMAGE_INDEX						15u
#define MASTER_SHADER_OPACITY_AOV_IMAGE_INDEX									16u
#define MASTER_SHADER_DEPTH_AOV_IMAGE_INDEX										17u
#define MASTER_SHADER_ALBEDO_AOV_IMAGE_INDEX									18u
#define MASTER_SHADER_LUMINANCE_AOV_IMAGE_INDEX									19u
#define MASTER_SHADER_RENDERABLE_INDEX_IMAGE_INDEX								20u
#define MASTER_SHADER_PRIMITIVE_INDEX_IMAGE_INDEX								21u
#define MASTER_SHADER_MATERIAL_INDEX_IMAGE_INDEX								22u
#define MASTER_SHADER_DEBUG_LAYER_IMAGE_INDEX									23u
