...
#define RAYTRACE_TOTAL_HITS_BUFFER_INDEX 6u
...
#define COMPUTE_SHADING_DATA_RENDERABLE_BUFFER_INDEX 				0u
...
#define COMPUTE_SHADING_DATA_RAY_INDEX_MAP_BUFFER_INDEX				4u
#define COMPUTE_SHADING_DATA_NORMAL_AOV_BUFFER_INDEX 				5u
#define COMPUTE_SHADING_DATA_UV_AOV_BUFFER_INDEX 					6u
#define COMPUTE_SHADING_DATA_WORLD_SPACE_POSITION_AOV_BUFFER_INDEX 	7u
...
#define COMPUTE_SHADE_MATERIAL_INDEX_MAP 						4u
#define COMPUTE_SHADE_MATERIAL_INDEX_AOV_MAP 					5u
#define COMPUTE_SHADE_MATERIALS_OFFSETS 						6u
#define COMPUTE_SHADE_THROUGHPUT_BUFFER 						7u
#define COMPUTE_SHADE_RENDER_ITERATION_BUFFER 					8u
#define COMPUTE_SHADE_NORMAL_AOV_DATA_INDEX 					9u
#define COMPUTE_SHADE_UV_AOV_DATA_INDEX 						10u
#define COMPUTE_SHADE_WORLD_SPACE_POSITION_AOV_DATA_INDEX 		11u
#define COMPUTE_SHADE_NORMAL_AOV_IMAGE_INDEX 					12u
#define COMPUTE_SHADE_UV_AOV_IMAGE_INDEX 						13u
#define COMPUTE_SHADE_WORLD_SPACE_POSITION_AOV_IMAGE_INDEX 		14u
...
#define COMPUTE_MISS_IBL_IMAGE_IMPORTANCE_SAMPLER_INDEX 2u
#define COMPUTE_MISS_IBL_IMAGE_SAMPLER_LINEAR_INDEX 3u
#define COMPUTE_MISS_IBL_IMAGE_SAMPLER_NEAREST_INDEX 4u
#define COMPUTE_MISS_MATERIAL_INDEX_MAP 5u
#define COMPUTE_MISS_MATERIAL_INDEX_AOV_MAP 6u
#define COMPUTE_MISS_MATERIALS_OFFSETS 7u
#define COMPUTE_MISS_THROUGHPUT_BUFFER 8u
#define COMPUTE_MISS_NORMAL_AOV_IMAGE_INDEX 9u
#define COMPUTE_MISS_UV_AOV_IMAGE_INDEX 10u

/// Task sample IBL set layout defines
#define RAYTRACE_SAMPLE_IBL_LAYOUT_INDEX 					0u

#define RAYTRACE_SAMPLE_IBL_TLAS_INDEX 						0u
#define RAYTRACE_SAMPLE_IBL_IMPORTANCE_SAMPLER_INDEX 		1u
#define RAYTRACE_SAMPLE_IBL_IMAGE_SAMPLER_INDEX 			2u
#define RAYTRACE_SAMPLE_IBL_NORMAL_AOV_IMAGE_INDEX 			3u
#define RAYTRACE_SAMPLE_IBL_SAMPLED_IBL_BUFFER_INDEX 		4u
#define RAYTRACE_SAMPLE_IBL_PIXEL_INDEX_BUFFER 				5u
#define RAYTRACE_SAMPLE_IBL_RENDER_ITERATION_BUFFER_INDEX 	6u
