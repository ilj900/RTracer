...
#define COMPUTE_SHADE_NORMAL_AOV_DATA_BUFFER 				9u
#define COMPUTE_SHADE_UV_AOV_DATA_BUFFER 					10u
#define COMPUTE_SHADE_WORLD_SPACE_POSITION_AOV_DATA_BUFFER 	11u
