...
#define COMPUTE_SHADE_NORMAL_AOV_DATA_BUFFER_INDEX 					9u
#define COMPUTE_SHADE_UV_AOV_DATA_BUFFER_INDEX 						10u
#define COMPUTE_SHADE_WORLD_SPACE_POSITION_AOV_DATA_BUFFER_INDEX	11u
