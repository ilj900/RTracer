...
#define MASTER_SHADER_THROUGHPUT_BUFFER											18u
#define MASTER_SHADER_COLOR_AOV_IMAGE_INDEX 									19u
#define MASTER_SHADER_SHADING_NORMAL_AOV_IMAGE_INDEX 							20u
#define MASTER_SHADER_GEOMETRIC_NORMAL_AOV_IMAGE_INDEX							21u
#define MASTER_SHADER_UV_AOV_IMAGE_INDEX										22u
#define MASTER_SHADER_WORLD_SPACE_POSITION_AOV_IMAGE_INDEX						23u
#define MASTER_SHADER_OPACITY_AOV_IMAGE_INDEX									24u
#define MASTER_SHADER_DEPTH_AOV_IMAGE_INDEX										25u
#define MASTER_SHADER_ALBEDO_AOV_IMAGE_INDEX									26u
#define MASTER_SHADER_LUMINANCE_AOV_IMAGE_INDEX									27u
#define MASTER_SHADER_RENDERABLE_INDEX_IMAGE_INDEX								28u
#define MASTER_SHADER_PRIMITIVE_INDEX_IMAGE_INDEX								29u
#define MASTER_SHADER_MATERIAL_INDEX_IMAGE_INDEX								30u
#define MASTER_SHADER_DEBUG_LAYER_IMAGE_INDEX									31u
