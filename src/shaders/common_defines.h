...
#define COMPUTE_SHADE_RENDERABLE_BUFFER_INDEX 1u
#define COMPUTE_SHADE_TRANSFORM_INDEX 2u
#define COMPUTE_SHADE_HITS_BUFFER_INDEX 3u
#define COMPUTE_SHADE_RAYS_BUFFER_INDEX 4u
#define COMPUTE_SHADE_SHADING_INFO 5u
#define COMPUTE_SHADE_TEXTURE_SAMPLER 6u
#define COMPUTE_SHADE_TEXTURE_ARRAY 7u
#define COMPUTE_SHADE_LIGHTS_BUFFER_INDEX 8u
#define COMPUTE_SHADE_MATERIAL_INDEX_MAP 9u
#define COMPUTE_SHADE_MATERIAL_INDEX_AOV_MAP 10u
#define COMPUTE_SHADE_MATERIALS_OFFSETS 11u
#define COMPUTE_SHADE_THROUGHPUT_BUFFER 12u
#define COMPUTE_SHADE_RENDER_ITERATION_BUFFER 13u
#define COMPUTE_SHADE_NORMAL_AOV_IMAGE_INDEX 14u
#define COMPUTE_SHADE_UV_AOV_IMAGE_INDEX 15u
