...
#define MATERIAL_SORT_COMPUTE_OFFSETS_LAYOUT_INDEX 0u

#define MATERIAL_SORT_MATERIALS_COUNT_PER_CHUNK_BUFFER 0u
#define MATERIAL_SORT_TOTAL_MATERIAL_OFFSETS_BUFFER 1u
#define MATERIAL_SORT_MATERIALS_OFFSETS_PER_CHUNK_BUFFER 2u
...
#define MATERIAL_SORT_COMPUTE_PREFIX_SUMS_LAYOUT_INDEX 0u

#define MATERIAL_SORT_COMPUTE_PREFIX_SUMS_BUFFER_A 0u
#define MATERIAL_SORT_COMPUTE_PREFIX_SUMS_BUFFER_B 1u
