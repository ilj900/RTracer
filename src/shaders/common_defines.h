...
#define MASTER_SHADER_POINT_LIGHTS_BUFFER_INDEX 								12u
#define MASTER_SHADER_POINT_LIGHTS_IMPORTANCE_BUFFER_INDEX						13u
#define MASTER_SHADER_IBL_IMPORTANCE_BUFFER_INDEX								14u
#define MASTER_SHADER_IBL_IMAGE_SAMPLER_INDEX									15u
#define MASTER_SHADER_IBL_WEIGHTS_BUFFER_INDEX									16u
#define MASTER_SHADER_UTILITY_BUFFER_INDEX 										17u
#define MASTER_SHADER_RENDER_ITERATION_BUFFER_INDEX 							18u
#define MASTER_SHADER_CUMULATIVE_MATERIAL_COLOR_BUFFER_INDEX					19u
#define MASTER_SHADER_NORMAL_BUFFER												20u
#define MASTER_SHADER_THROUGHPUT_BUFFER											21u
#define MASTER_SHADER_COLOR_AOV_IMAGE_INDEX 									22u
#define MASTER_SHADER_SHADING_NORMAL_AOV_IMAGE_INDEX 							23u
#define MASTER_SHADER_GEOMETRIC_NORMAL_AOV_IMAGE_INDEX							24u
#define MASTER_SHADER_UV_AOV_IMAGE_INDEX										25u
#define MASTER_SHADER_WORLD_SPACE_POSITION_AOV_IMAGE_INDEX						26u
#define MASTER_SHADER_OPACITY_AOV_IMAGE_INDEX									27u
#define MASTER_SHADER_DEPTH_AOV_IMAGE_INDEX										28u
#define MASTER_SHADER_ALBEDO_AOV_IMAGE_INDEX									29u
#define MASTER_SHADER_LUMINANCE_AOV_IMAGE_INDEX									30u
#define MASTER_SHADER_RENDERABLE_INDEX_IMAGE_INDEX								31u
#define MASTER_SHADER_PRIMITIVE_INDEX_IMAGE_INDEX								32u
#define MASTER_SHADER_MATERIAL_INDEX_IMAGE_INDEX								33u
#define MASTER_SHADER_DEBUG_LAYER_IMAGE_0_INDEX									34u
#define MASTER_SHADER_DEBUG_LAYER_IMAGE_1_INDEX									35u
#define MASTER_SHADER_DEBUG_LAYER_IMAGE_2_INDEX									36u
#define MASTER_SHADER_DEBUG_LAYER_IMAGE_3_INDEX									37u
