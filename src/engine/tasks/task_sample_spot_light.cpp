...
void FSampleSpotLightTask::UpdateDescriptorSets()
{
    for (size_t i = 0; i < TotalSize; ++i)
    {
		...
		UpdateDescriptorSet(RAYTRACE_SAMPLE_SPOT_LIGHT_LAYOUT_INDEX, RAYTRACE_SAMPLE_SPOT_LIGHT_UNIFORM_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer("UtilityInfoSpotLight"));
        UpdateDescriptorSet(RAYTRACE_SAMPLE_SPOT_LIGHT_LAYOUT_INDEX, RAYTRACE_SAMPLE_SPOT_LIGHT_NORMAL_AOV_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer("NormalAOVBuffer"));
		UpdateDescriptorSet(RAYTRACE_SAMPLE_SPOT_LIGHT_LAYOUT_INDEX, RAYTRACE_SAMPLE_SPOT_LIGHT_WORLD_SPACE_POSITION_AOV_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer("WorldSpacePositionAOVBuffer"));
        UpdateDescriptorSet(RAYTRACE_SAMPLE_SPOT_LIGHT_LAYOUT_INDEX, RAYTRACE_SAMPLE_SPOT_LIGHT_SAMPLED_LIGHT_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer("SampledSpotLightBuffer"));
		UpdateDescriptorSet(RAYTRACE_SAMPLE_SPOT_LIGHT_LAYOUT_INDEX, RAYTRACE_SAMPLE_SPOT_LIGHT_PIXEL_INDEX_BUFFER, i, RESOURCE_ALLOCATOR()->GetBuffer("PixelIndexBuffer"));
		UpdateDescriptorSet(RAYTRACE_SAMPLE_SPOT_LIGHT_LAYOUT_INDEX, RAYTRACE_SAMPLE_SPOT_LIGHT_RENDER_ITERATION_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer("RenderIterationBuffer"));
    }
};
