...
{VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	...
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_SHADING_NORMAL_AOV_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_GEOMETRIC_NORMAL_AOV_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_UV_AOV_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_WORLD_SPACE_POSITION_AOV_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_OPACITY_AOV_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_DEPTH_AOV_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_ALBEDO_AOV_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_LUMINANCE_AOV_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_RENDERABLE_INDEX_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_PRIMITIVE_INDEX_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_MATERIAL_INDEX_IMAGE_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_DEBUG_LAYER_IMAGE_0_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_DEBUG_LAYER_IMAGE_1_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_DEBUG_LAYER_IMAGE_2_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_DEBUG_LAYER_IMAGE_3_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
...
void FMasterShader::UpdateDescriptorSets()
{
	...
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_SHADING_NORMAL_AOV_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("ShadingNormalAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_GEOMETRIC_NORMAL_AOV_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("GeometricNormalAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_UV_AOV_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("UVAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_WORLD_SPACE_POSITION_AOV_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("WorldSpacePositionAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_OPACITY_AOV_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("OpacityAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_DEPTH_AOV_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("DepthAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_ALBEDO_AOV_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("AlbedoAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_LUMINANCE_AOV_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("LuminanceAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_RENDERABLE_INDEX_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("RenderableIDAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_PRIMITIVE_INDEX_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("PrimitiveIDAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_MATERIAL_INDEX_IMAGE_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("MaterialIDAOVImage"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_DEBUG_LAYER_IMAGE_0_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("DebugLayerImage0"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_DEBUG_LAYER_IMAGE_1_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("DebugLayerImage1"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_DEBUG_LAYER_IMAGE_2_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("DebugLayerImage2"));
	UpdateDescriptorSet(MASTER_SHADER_LAYOUT_STATIC_INDEX, MASTER_SHADER_DEBUG_LAYER_IMAGE_3_INDEX, 0, TEXTURE_MANAGER()->GetFramebufferImage("DebugLayerImage3"));
