        ...
        FExecutableTask(WidthIn, HeightIn, SubmitXIn, SubmitYIn, LogicalDevice)
{
	...
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_FLOAT_TEXTURE_ARRAY,
		{VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR, MAX_TEXTURES});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_UINT_TEXTURE_ARRAY,
		{VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR, MAX_TEXTURES});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_INT_TEXTURE_ARRAY,
		{VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE,  VK_SHADER_STAGE_RAYGEN_BIT_KHR, MAX_TEXTURES});
	...
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_DIRECTIONAL_LIGHTS_BUFFER_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_DIRECTIONAL_LIGHTS_IMPORTANCE_BUFFER_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_SPOT_LIGHTS_BUFFER_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
	DescriptorSetManager->AddDescriptorLayout(Name, MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_SPOT_LIGHTS_IMPORTANCE_BUFFER_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,  VK_SHADER_STAGE_RAYGEN_BIT_KHR});
...
void FMasterShader::UpdateDescriptorSets()
{
    for (size_t i = 0; i < TotalSize; ++i)
    {
		...
		VK_CONTEXT()->DescriptorSetManager->UpdateDescriptorSetInfo(Name, MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_FLOAT_TEXTURE_ARRAY, i, DescriptorImageInfosFloat);
    	auto DescriptorImageInfosUint = TEXTURE_MANAGER()->GetDescriptorImageInfosUint();
    	VK_CONTEXT()->DescriptorSetManager->UpdateDescriptorSetInfo(Name, MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_UINT_TEXTURE_ARRAY, i, DescriptorImageInfosUint);
    	auto DescriptorImageInfosInt = TEXTURE_MANAGER()->GetDescriptorImageInfosInt();
    	VK_CONTEXT()->DescriptorSetManager->UpdateDescriptorSetInfo(Name, MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_INT_TEXTURE_ARRAY, i, DescriptorImageInfosInt);
		...
		UpdateDescriptorSet(MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_DIRECTIONAL_LIGHTS_IMPORTANCE_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer(DIRECTIONAL_LIGHTS_IMPORTANCE_BUFFER));
        ...
        UpdateDescriptorSet(MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_AREA_LIGHTS_BUFFER_INDEX, i, AREA_LIGHT_SYSTEM()->DeviceBuffer);
        UpdateDescriptorSet(MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_AREA_LIGHTS_IMPORTANCE_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer(AREA_LIGHTS_IMPORTANCE_BUFFER));
		...
		UpdateDescriptorSet(MASTER_SHADER_LAYOUT_INDEX, MASTER_SHADER_IBL_IMAGE_SAMPLER_INDEX, i, TEXTURE_MANAGER()->GetIBLImage(), IBLSampler);
