        ...
        FExecutableTask(WidthIn, HeightIn, SubmitXIn, SubmitYIn, LogicalDevice)
{
    ...
    DescriptorSetManager->AddDescriptorLayout(Name, COMPUTE_SHADING_DATA_LAYOUT_INDEX, COMPUTE_SHADING_DATA_RENDERABLE_BUFFER_INDEX,
    ...
    DescriptorSetManager->AddDescriptorLayout(Name, COMPUTE_SHADING_DATA_LAYOUT_INDEX, COMPUTE_SHADING_DATA_RAYS_BUFFER_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,  VK_SHADER_STAGE_COMPUTE_BIT});
	DescriptorSetManager->AddDescriptorLayout(Name, COMPUTE_SHADING_DATA_LAYOUT_INDEX, COMPUTE_SHADING_DATA_RAY_INDEX_MAP_BUFFER_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,  VK_SHADER_STAGE_COMPUTE_BIT});
	DescriptorSetManager->AddDescriptorLayout(Name, COMPUTE_SHADING_DATA_LAYOUT_INDEX, COMPUTE_SHADING_DATA_NORMAL_AOV_BUFFER_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,  VK_SHADER_STAGE_COMPUTE_BIT});
	DescriptorSetManager->AddDescriptorLayout(Name, COMPUTE_SHADING_DATA_LAYOUT_INDEX, COMPUTE_SHADING_DATA_UV_AOV_BUFFER_INDEX,
		{VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,  VK_SHADER_STAGE_COMPUTE_BIT});
...
void FComputeShadingDataTask::UpdateDescriptorSets()
{
    ...
    {
        UpdateDescriptorSet(COMPUTE_SHADING_DATA_LAYOUT_INDEX, COMPUTE_SHADING_DATA_RENDERABLE_BUFFER_INDEX, i, RENDERABLE_SYSTEM()->DeviceBuffer);
		...
		UpdateDescriptorSet(COMPUTE_SHADING_DATA_LAYOUT_INDEX, COMPUTE_SHADING_DATA_RAY_INDEX_MAP_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer("PixelIndexBuffer"));
        UpdateDescriptorSet(COMPUTE_SHADING_DATA_LAYOUT_INDEX, COMPUTE_SHADING_DATA_NORMAL_AOV_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer("NormalAOVBuffer"));
        UpdateDescriptorSet(COMPUTE_SHADING_DATA_LAYOUT_INDEX, COMPUTE_SHADING_DATA_UV_AOV_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer("UVAOVBuffer"));
        UpdateDescriptorSet(COMPUTE_SHADING_DATA_LAYOUT_INDEX, COMPUTE_SHADING_DATA_WORLD_SPACE_POSITION_AOV_BUFFER_INDEX, i, RESOURCE_ALLOCATOR()->GetBuffer("WorldSpacePositionAOVBuffer"));
    }
};
