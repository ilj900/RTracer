...
enum class EOutputType {
	...
	MaterialSpecularColo				= AOV_MATERIAL_SPECULAR_COLOR,
	...
	MaterialTransmissionColo			= AOV_MATERIAL_TRANSMISSION_COLOR,
	MaterialTransmissionDepth			= AOV_MATERIAL_TRANSMISSION_DEPTH,
	MaterialTransmissionScatte			= AOV_MATERIAL_TRANSMISSION_SCATTER,
	...
	MaterialSubsurfaceColo				= AOV_MATERIAL_SUBSURFACE_COLOR,
	MaterialSubsurfaceRadiu				= AOV_MATERIAL_SUBSURFACE_RADIUS,
	...
	MaterialCoatNorma					= AOV_MATERIAL_COAT_NORMAL,
