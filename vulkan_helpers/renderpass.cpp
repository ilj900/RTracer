...
void FRenderPass::Construct(VkDevice LogicalDevice)
{
    ...
    Subpass.pDepthStencilAttachment = (DepthStencilAttachmentDescriptions.empty()) ?  nullptr : &DepthAttachmentReference;
    Subpass.pResolveAttachments = (ResolvedAttachmentReferences.empty()) ? nullptr : ResolvedAttachmentReferences.data();
